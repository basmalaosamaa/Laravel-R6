    ...
    <div class="container my-5">
      <div class="form-container">
        ...
        <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" placeholder="Enter Class Name.." class="form-control py-2" name="className" />
            </div>
          </div>
          <div class="form-group mb-3 row">
            <label for="capacity" class="form-label col-md-2 fw-bold text-md-end">Capacity:</label>
            <div class="col-md-10">
              <input type="number" id="capacity" name="capacity" min="1" required class="form-control py-2">
            </div>
          </div>
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="number" id="price" name="price" min="0" step="0.01" required class="form-control py-2">
            </div>
          </div>
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="time" id="timeFrom" name="timeFrom" required class="form-control py-2">
            </div>
          </div>
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="time" id="timeTo" name="timeTo" required class="form-control py-2">
            </div>
          </div>
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="checkbox" id="isFulled" name="isFulled" class="form-check-input" style="padding: 0.7rem;">
            </div>
          </div>
