        ...
        <div class="card bg-light border-0">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 col-10 position-relative overflow-hidden">
              <img src="https://img.freepik.com/premium-photo/teacher-day-class-room_1007515-303.jpg"
                alt="" class="card-img"
                style="position: absolute; margin: auto; top: 50%; transform: translateY(-50%); width: 436px ;height: 308px; object-fit: cover;" />
            </div>
            ...
            <div class="col-lg-8 col-md-6 col-12 card-body">
              ...
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Is Fulled:</span> {{ $class->isFulled ? 'Yes' : 'No' }}
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
